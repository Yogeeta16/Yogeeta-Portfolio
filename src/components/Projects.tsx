...
const projects: Project[] = [
  {
    ...
    imageUrl: "../src/projectImages/EMED01.png",
    imageGallery: [
      "../src/projectImages/EMED01.png",
      "../src/projectImages/EMED02.png",
      "../src/projectImages/EMED03.png",
      "../src/projectImages/EMED04.png",
      "../src/projectImages/EMED05.png",
      "../src/projectImages/EMED06.png",
      "../src/projectImages/EMED07.png",
      "../src/projectImages/EMED08.png",
      "../src/projectImages/EMED09.png",
      "../src/projectImages/EMED10.png",
      "../src/projectImages/EMED11.png",
  ...
  },
  {
    ...
    imageUrl: "../src/projectImages/ProductFeedBack01.png",
    imageGallery: [
      "../src/projectImages/ProductFeedBack01.png",
      "../src/projectImages/ProductFeedBack02.png",
      "../src/projectImages/ProductFeedBack03.png",
      "../src/projectImages/ProductFeedBack04.png",
    ],
    type: "frontend",
  ...
  },
  {
    ...
    imageUrl: "../src/projectImages/Tetris03.png",
    imageGallery: [
      "../src/projectImages/Tetris01.png",
      "../src/projectImages/Tetris02.png",
      "../src/projectImages/Tetris03.png",
    ],
    type: "frontend",
  ...
  },
  {
    ...
    imageUrl: "../src/projectImages/Movie01.png",
    imageGallery: [
      "../src/projectImages/Movie01.png",
      "../src/projectImages/Movie02.png",
  ...
  },
  {
    ...
    imageUrl: "../src/projectImages/TaskManager03.png",
    imageGallery: [
      "../src/projectImages/TaskManager01.png",
      "../src/projectImages/TaskManager02.png",
      "../src/projectImages/TaskManager03.png",
      "../src/projectImages/TaskManager04.png",
    ],
    type: "frontend",
    technologies: ["JavaScript", "HTML5", "CSS3", "LocalStorage"],
  ...
  },
  {
    ...
    imageUrl: "../src/projectImages/HotelBooking01.png",
     type: "backend",
    technologies: ["Java", "SpringBoot", "REST API", "MySQL"],
  ...
  },
  {
    ...
    imageUrl: "src/projectImages/EmployeeManagement01.png",
    type: "backend",
    technologies: ["Java", "SpringBoot", "REST API", "MySQL"],
  ...
  },
  {
    ...
    imageUrl: "../src/projectImages/PatientAppointment01.png",
    type: "backend",
    technologies: ["Java", "SpringBoot", "REST API", "MySQL"],
  ...
  },
  {
    ...
    imageUrl: "../src/projectImages/Automobile02.png",
    type: "backend",
    technologies: ["Java", "SpringBoot", "REST API", "MySQL"],
